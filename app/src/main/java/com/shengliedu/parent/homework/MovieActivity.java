...
import com.shengliedu.parent.view.MovieRecorderView;
...
public class MovieActivity extends Activity {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					if (mRecorderView.getTimeCount() > 1)
						...
						mRecorderView.stop();
						Toast.makeText(MovieActivity.this, "视频录制时间太短",
	 ...
	 */
	/*
	 * public static String createFilePath(String folderName) { File file = new
	 * File
	 * (android.os.Environment.getExternalStorageDirectory()+"/"+folderName);
	 * file.mkdir(); String path = file.getPath(); return path; }
	 *//**
	 * 获取当前时间
	 * 
	 * @return 日期的字符串信息
	 ...
	 * SimpleDateFormat("yyyy-MM-dd_HH-mm-ss"); String strDate =
	 * dateFormat.format(new Date()); return strDate; }
	 */
