 ...
 * 
 */
public class SelectPicker extends View {
	/** 控件宽度 */
...
//	private ArrayList<Unit> unitList = new ArrayList<Unit>();
	...
	/** 选中的时候字体 */
	private float selectedFont = BaseActivity.screenwidth / 23; 
	/** 默认字体 */
	...
	public SelectPicker(Context context, AttributeSet attrs,
			int defStyle) {
	...
	private void initData(int type) {
		...
		case 1:
			...
			for (int i = 0; i < cityList.size(); i++) {
				...
				itmItemObject.id = i;
				itmItemObject.itemText = cityList.get(i);
				itmItemObject.x = 0;
...
//				ItemObject itmItemObject = new ItemObject();
//				itmItemObject.id = i;
//				itmItemObject.itemText = unitList.get(i).PayeeNm;
//				itmItemObject.x = 0;
//				itmItemObject.y = i * unitHeight;
//				itemList.add(itmItemObject);
//			}
//			break;
	 ...
	 * @param data
	 */
	public void setCity(ArrayList<String> data) {
		this.cityList = data;
		initData(1);
	}
