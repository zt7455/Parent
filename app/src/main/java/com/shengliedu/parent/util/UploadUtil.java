...
public class UploadUtil {
	...
	public String uploadFile(File file, String RequestURL,
			String coursewareContentId, String userId) {
		...
		try {
			...
			if (file != null) {
				...
				String content = PREFIX + BOUNDARY + LINE_END
						...
						+ LINE_END + LINE_END + "homework/"
						+ coursewareContentId + "/" + userId + LINE_END;
				...
				Log.e("******************", content);
				Log.e("##################", sb.toString());
				Log.e("-------------", "coursewareContentId="
						+ coursewareContentId + "userId=" + userId);
				if (HttpImage.isImage3(file)) {
					HttpImage.compressPicture(file.getAbsolutePath(),file.getAbsolutePath());
				}
