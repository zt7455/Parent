				...
				case R.id.month:
					if (page==0) {
						...
						.replace(
								R.id.ak_content,
								new WebFragment(
										DutyActivity.this, 2,studentId, smDate,
										emDate)).commit();
					}
					break;
				case R.id.day:
					if (page==1) {
						...
						.replace(
								R.id.ak_content,
								new WebFragment(
										DutyActivity.this, 2,studentId, dayDate,
										dayDate)).commit();
					}
					break;
				case R.id.week:
					if (page==2) {
						...
						.replace(
								R.id.ak_content,
								new WebFragment(
										DutyActivity.this,2,studentId, swDate,
										ewDate)).commit();
					}
					break;
				default:
						...
						for (int i = 0; i < month.size(); i++) {
							if (m == i) {
								...
								break;
									...
									Toast.makeText(DutyActivity.this, "已经是第一月了", Toast.LENGTH_SHORT)
									.show();
								}
							}
						}
						...
						for (int i = 0; i < week.size(); i++) {
							if (w == i) {
								...
								break;
									...
									Toast.makeText(DutyActivity.this, "已经是第一周了", Toast.LENGTH_SHORT)
									.show();
								}
							}
						}
						...
						for (int i = 0; i < month.size(); i++) {
							if (m == i) {
								...
								break;
									...
									Toast.makeText(DutyActivity.this, "已经是最后一月了", Toast.LENGTH_SHORT)
									.show();
								}
							}
						}
						...
						for (int i = 0; i < week.size(); i++) {
							if (w == i) {
								...
								break;
									...
									Toast.makeText(DutyActivity.this, "已经是最后一周了", Toast.LENGTH_SHORT)
									.show();
								}
							}
						}
