...
//                                    v.setBackgroundResource(R.mipmap.custom_dialog_ok_pressed);
                                    break;
                                case MotionEvent.ACTION_UP:
//                                    v.setBackgroundResource(R.mipmap.custom_dialog_ok);
                                    break;
                            }
                ...
                if (negativeButtonClickListener != null) {
                    ...
                    ((TextView) layout.findViewById(R.id.negativeButton)).setOnTouchListener(new OnTouchListener() {
                        public boolean onTouch(View v, MotionEvent event) {
                            switch (event.getAction()) {
                                case MotionEvent.ACTION_DOWN:
//                                    v.setBackgroundResource(R.mipmap.custom_dialog_cancle_pressed);
                                    break;
                                case MotionEvent.ACTION_UP:
//                                    v.setBackgroundResource(R.mipmap.custom_dialog_cancle);
                                    break;
                            }
                            return false;
                        }
            ...
            if (message != null) {
                ...
                ((LinearLayout) layout.findViewById(R.id.mes))
                        .removeAllViews();
