package com.shengliedu.parent.pdf;
...
public class ShowPdfFromUrlActivity extends BaseActivity implements OnPageChangeListener {
	private String url;
	...
	private void downLoad(String url) {
		...
		if (!file.exists()) {
					...
					zzktHttpDownLoad.downloads(replace(url),
