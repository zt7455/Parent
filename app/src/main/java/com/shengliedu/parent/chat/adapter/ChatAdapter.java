...
import com.shengliedu.parent.chat.activitys.MapActivity;
import com.shengliedu.parent.chat.activitys.ShowPicActivitiy;
...
import com.shengliedu.parent.chat.util.StringUtil;
import com.shengliedu.parent.chat.util.Tool;
import com.shengliedu.parent.chat.view.expression.ExpressionUtil;
import com.shengliedu.parent.chat.view.gifView.GifView;
import com.shengliedu.parent.chat.view.gifView.GifView.GifImageType;
...
public class ChatAdapter extends ArrayAdapter<ChatItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.head.setTag(item.username);
		// head
	...
	private void playGif(GifView gif, TextView msgView, ImageView img,
		...
		try {
			Field field = R.mipmap.class.getDeclaredField(msg.substring(2,
					msg.indexOf("]")));
