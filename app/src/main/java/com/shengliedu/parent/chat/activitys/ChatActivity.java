...
import com.shengliedu.parent.chat.adapter.ChatAdapter;
...
import com.shengliedu.parent.chat.util.ImageUtil;
import com.shengliedu.parent.chat.util.Tool;
import com.shengliedu.parent.chat.view.D3View;
import com.shengliedu.parent.chat.view.MyListView;
import com.shengliedu.parent.chat.view.MyListView.OnRefreshListener;
import com.shengliedu.parent.chat.view.RecordButton;
import com.shengliedu.parent.chat.view.RecordButton.OnFinishedRecordListener;
import com.shengliedu.parent.chat.view.expression.ExpressionListener;
import com.shengliedu.parent.chat.view.expression.ExpressionView;
...
import static com.shengliedu.parent.app.App.lat;
import static com.shengliedu.parent.app.App.lon;
	...
	protected void onCreate(Bundle arg0) {
		...
		mLocationClient.registerLocationListener(new BDLocationListener() {
			...
			public void onReceiveLocation(BDLocation location) {
				...
				Log.v("TAG", "onReceiveLocation:"+adr);
				try {
...
//				Tool.initToast(getApplicationContext(), adr);
	...
	private void initView() {
		...
		registerReceiver(mUpMessageReceiver, new IntentFilter("pChatNewMsg"));
	...
	public void autoSendIfFail(final String msg){
		Tool.initToast(App.getInstance(), "发送中..");
		...
		timer.schedule(new TimerTask() {  //1秒后开始
			...
			public void run() {
				try {
					...
					if (count > 8) {
						Tool.initToast(App.getInstance(), "发送失败");
						timer.cancel();
					}
				}
			}
