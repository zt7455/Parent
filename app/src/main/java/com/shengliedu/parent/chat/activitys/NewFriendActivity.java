...
import com.shengliedu.parent.chat.adapter.SearchAdapter;
...
public class NewFriendActivity extends BaseActivity {
	...
	protected void onDestroy() {
		NewMsgDbHelper.getInstance(App.getInstance()).delNewMsg(""+0);
		App.getInstance().sendBroadcast(new Intent("FriendNewMsg"));
		super.onDestroy();
	}
